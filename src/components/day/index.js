...
class Day extends Component {
    ...
    render() {
        ...
        <div className="forecast">
		    ...
		    <div className="forecast-img"><img src={ require('./img/' + icon) } alt={ data.weather.description } /></div>
		    <div className="forecast-temp-avg">{temp_avg}</div>
		    <div className="forecast-max-temp-app fl">Maximum temperature <span className="fv">{temp_max}</span></div>
		    <div className="forecast-min-temp-app fl">Minimum temperature <span className="fv">{temp_min}</span></div>
		    <div className="forecast-pres fl">Pressure <span className="fv">{data.pres} mb</span></div>
		    <div className="forecast-rh fl">Humidity <span className="fv">{data.rh} %</span></div>
		    <div className="forecast-wind_spd fl">Wind <span className="fv">{data.wind_cdir_full}, {data.wind_spd} m/s</span></div>
	    </div>
        )
    }
}
